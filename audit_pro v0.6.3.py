...
LEGACY_FILE_EXT      = ".caf"
LEGACY_FILE_EXT_DESC = "Legacy Company Audit File"
OPEN_FILETYPES = [
    (f"{FILE_EXT_DESC}s",        f"*{FILE_EXT} *{LEGACY_FILE_EXT}"),
    (FILE_EXT_DESC,              f"*{FILE_EXT}"),
    (LEGACY_FILE_EXT_DESC,       f"*{LEGACY_FILE_EXT}"),
    ("All files",                "*.*"),
]
...
LEGAL_SEC_ITEMS = [
    ...
    ("ls_mca_filing_msme1",  "MSME-1 & 2 (Outstanding Payments to MSME)",    "item"),
    ("ls_mca_filing_llpin",  "LLP Annual Filing (if applicable)",        "item"),
    ("ls_mca_filing_inddir",  "Independent Director (if applicable)",        "item"),
    ("ls_mca_filing_womdir",  "Women Director (if applicable)",        "item"),

    # ── Directors Powers ────────────────────────────────────────────────────
    ("ls_directorpower", "Directors Powers", "header"),

    ("ls_sec180",    "Section 180 Borrowing Powers",                 "item"),
    ("ls_sec185",    "Section 185 Loans to Directors etc.",          "item"),
    ("ls_sec186",    "Section 186 Loans, Investments etc.",          "item"),
    ("ls_sec188",    "Section 188 Transactions with Related Parties","item"),
    ("ls_othrpow",   "Other Powers",                                 "item"),
...
def migrate(data):
    if "engagements" in data and isinstance(data["engagements"], list):
        # Modern-format files should always carry a company name; back-fill it so
        # callers (e.g. DetailPanel) can index it unconditionally.
        data.setdefault("company_name", "Untitled")
